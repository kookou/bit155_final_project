...
public enum CustomOAuth2Provider { 
	KAKAO { 
		...
		public ClientRegistration.Builder getBuilder(String registrationId) { 
			...
			builder.scope("profile"); builder.authorizationUri("https://kauth.kakao.com/oauth/authorize"); 
	...
	private static final String DEFAULT_LOGIN_REDIRECT_URL = "{baseUrl}/signin/oauth2/code/{registrationId}"; 
