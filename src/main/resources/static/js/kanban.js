...
//  const boardContainer = document.querySelector('.main-wrapper .kanban-container');
//  const board = document.querySelector('.main-wrapper .kanban');
...
//	  var kanban = document.querySelector('.kanban-container');
//	  var board = kanban.querySelector('.kanban');
//	  var itemContainers = Array.prototype.slice.call(kanban.querySelectorAll('.divForDragNDrop'));
//	  var columnGrids = [];
//	  var dragCounter = 0;
//	  var boardGrid;
//
